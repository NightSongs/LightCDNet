...
if __name__ == '__main__':
    pred_root = r'D:\jjw\Python\RS-CD\open-cd-main\infer\tmp_infer\LEVIR-CD\tmp_infer_lightcdnet-s'
    label_root = r'D:\jjw\Python\RS-CD\open-cd-main\data\LEVIR-CD\test\label'
